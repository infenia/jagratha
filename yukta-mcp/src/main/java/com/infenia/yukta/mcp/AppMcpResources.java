...
public class AppMcpResources {
  ...
  @McpResource(uri = "yukta://overview", name = "Yukta Overview", description = "High-level overview of Yukta's capabilities and architecture")
  ...
  @McpResource(uri = "yukta://architecture", name = "Yukta Architecture", description = "Detailed deep dive into Yukta's DAG and Reactive architecture")
  ...
  @McpResource(uri = "yukta://sessions/{sessionId}/logs", name = "Session Logs", description = "Full logs for a specific session")
  public Mono<String> getSessionLogs(String sessionId) {
    return logProvider.streamSessionLogs(sessionId, null, null, null)
        .collectList()
