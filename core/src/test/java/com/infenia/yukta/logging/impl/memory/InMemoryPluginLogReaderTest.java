...
class InMemoryPluginLogReaderTest {
  ...
  void testReadExecution() {
    addEntry("exec-123", "session-456", "node-001", "plugin-1", "Message 1");
    addEntry("exec-123", "session-456", "node-002", "plugin-2", "Message 2");
  ...
  void testReadSession() {
    addEntry("exec-001", "session-456", "node-001", "plugin-1", "Exec 1");
    addEntry("exec-002", "session-456", "node-001", "plugin-1", "Exec 2");
    addEntry("exec-003", "session-789", "node-001", "plugin-1", "Other session");
  ...
  void testListExecutions() {
    addEntry("exec-001", "session-456", "node-001", "plugin-1", "Line 1");
    addEntry("exec-001", "session-456", "node-001", "plugin-1", "Line 2");
    addEntry("exec-002", "session-456", "node-001", "plugin-1", "Line 3");
  ...
  void testGetRawContent() {
    addEntry("exec-123", "session-456", "node-001", "plugin-1", "Line 1");
    addEntry("exec-123", "session-456", "node-001", "plugin-1", "Line 2");
