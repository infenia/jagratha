...
class HeartbeatBuilderTest {
  ...
  void testForNodes_validWfIdAndNodeList_setsNodesAndReturnsBuilder() {
    List<String> nodeList = List.of("node-1", "node-2");
    HeartbeatBuilder result = builder.forNodes("workflow-1", nodeList);
  ...
  void testForNodes_blankWfId_setsNodesStill() {
    List<String> nodeList = List.of("node-1");
    HeartbeatBuilder result = builder.forNodes("", nodeList);
  ...
  void testForNodes_nullNodeList_createsEmptyDisposables() {
    HeartbeatBuilder result = builder.forNodes("workflow-1", null);
  ...
  void testForNodes_emptyNodeList_createsEmptyDisposables() {
    HeartbeatBuilder result = builder.forNodes("workflow-1", new ArrayList<>());
  ...
  void testWithHeartbeatInterval_validDuration_setsIntervalAndReturnsBuilder() {
    HeartbeatBuilder result = builder.withHeartbeatInterval(CUSTOM_HB_INTERVAL);
  ...
  void testWithHeartbeatInterval_nullDuration_returnsBuilder() {
    HeartbeatBuilder result = builder.withHeartbeatInterval(null);
  ...
  void testWithStatisticsInterval_validDuration_setsIntervalAndReturnsBuilder() {
    HeartbeatBuilder result = builder.withStatisticsInterval(CUSTOM_STATS_INTERVAL);
  ...
  void testWithStatisticsInterval_nullDuration_returnsBuilder() {
    HeartbeatBuilder result = builder.withStatisticsInterval(null);
  ...
  void testBuild_statisticsUsesDefaultWhenHeartbeatNotSet() {
    Duration customStats = Duration.ofSeconds(5);
  ...
  void testBuild_createsFreshDisposablesOnEachCall() {
    builder.forNodes("workflow-1", List.of("node-1"));
    List<Disposable> firstBuild = builder.build();
    List<Disposable> secondBuild = builder.build();
  ...
  void testForNodes_createsNewArrayListCopy() {
    List<String> originalList = new ArrayList<>(List.of("node-1"));
    builder.forNodes("workflow-1", originalList);

    List<Disposable> disposables1 = builder.build();
    assertThat(disposables1).hasSize(2);

    originalList.add("node-2");
    List<Disposable> disposables2 = builder.build();
