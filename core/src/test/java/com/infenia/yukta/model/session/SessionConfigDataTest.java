...
class SessionConfigDataTest {
    ...
    final var workflows =
        Map.of(
            ...
            new WorkflowDefinition(
                "wf1",
                "desc",
                List.of(new WorkflowDefinition.Node("n1", "t1", null)),
                null));
    final var data =
  ...
  void validationShouldFailWhenDescriptionExceedsMaxLength() {
    ...
    final var data =
        new SessionConfigData(
            "session-1", "test", tooLongDescription, "initiator", null, "/path",
            workflows);
    final var result = validator.validateProperty(data, "description");
    assertThat(result).isNotEmpty();
  }
  ...
  void validationShouldNotFailWithValidInitiator(final String initiator) {
    ...
    final var data =
        new SessionConfigData(
            "session-1", "test", "desc", initiator, null, "/path", workflows);
    ...
    final var workflows =
        Map.of(
            ...
            new WorkflowDefinition(
                "wf2",
                "desc",
                List.of(new WorkflowDefinition.Node("n2", "t2", null)),
                null));
    final var data =
        new SessionConfigData(
            "session-1", "test", "desc", "initiator", null, "/path", workflows);
