...
coverageConfig {
    ...
    exceptions.put("*SessionService", mapOf("BRANCH" to 0.62, "INSTRUCTION" to 0.98))
    exceptions.put("*HeartbeatBuilder", mapOf("BRANCH" to 0.66, "INSTRUCTION" to 0.84, "METHOD" to 0.66))
    exceptions.put("*WorkflowCompiler", mapOf("BRANCH" to 0.96))
    exceptions.put("*TopologicalSortService", mapOf("BRANCH" to 0.94))
    ...
    exceptions.put("*DefaultTaskTrackerService", mapOf("LINE" to 0.98, "BRANCH" to 0.92, "INSTRUCTION" to 0.99, "METHOD" to 0.97))
    exceptions.put("*DirectiveDispatcher", mapOf("LINE" to 0.87, "INSTRUCTION" to 0.88, "METHOD" to 0.82))
    exceptions.put("*ControlBusService", mapOf("LINE" to 0.92, "BRANCH" to 0.76, "INSTRUCTION" to 0.91, "METHOD" to 0.97))
    exceptions.put("*WorkflowExecutionSnapshot", mapOf("BRANCH" to 0.50, "INSTRUCTION" to 0.94))
