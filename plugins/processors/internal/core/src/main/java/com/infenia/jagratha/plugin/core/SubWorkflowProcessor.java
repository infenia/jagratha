...
public class SubWorkflowProcessor implements ProcessorPlugin {
  ...
  public String getUsagePattern() {
    return """
        ...
        - inputMapper: Optional SpEL expression to transform parent message into child trigger payload.
        - outputMapper: Optional SpEL expression to transform child execution results back into the final node output.""";
  }
