...
public class GuardProcessor implements ProcessorPlugin {
  ...
  public String getDescription() {
    return "Evaluates a boolean condition and routes the message to 'true' or 'false' ports based on the result.";
  }
  ...
  public String getUsagePattern() {
    return """
        ...
        - strictMode: Boolean. If true (default), throws exception on evaluation error if errorPort is not set.
        - errorPort: Optional port name to route messages when evaluation fails. Adds 'error_message' to metadata.""";
  }
